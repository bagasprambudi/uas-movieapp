...
import 'package:project_uas/layout/states.dart';
import 'package:project_uas/model/movie_model.dart';
import 'package:project_uas/network/dio_helper.dart';
...
class MovieCubit extends Cubit<MovieStates> {
  ...
  void getPopularMovie() {
    ...
    DioHelper.getData(url: 'movie/popular', query: {
  ...
  void getUpComingMovie() {
    ...
    DioHelper.getData(url: 'movie/upcoming', query: {
      'api_key': '58b29b46048441216fa7c3562cb5eba9',
    }).then((value) {
      movieModel = MovieResultModel.fromJson(value.data);
  ...
  void addFavorite(int movieId) {
    ...
    if (isExist >= 0) {
      ...
      favoriteList.add(
          movieModel!.results!.firstWhere((element) => element.id == movieId));
    }
    print(favoriteList);
  }
